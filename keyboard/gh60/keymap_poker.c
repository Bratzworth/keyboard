...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP_ANSI(
        ...
        LCTL,FN0,LALT,               SPC,                 RALT,RGUI,APP, RCTL, PGDN),
    /* 1: colemak */
    KEYMAP_ANSI(
    ...
    KEYMAP_ANSI(
        ...
        TRNS,TRNS,UP,  TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,SLCK, \
        TRNS,LEFT,DOWN,RGHT,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,BRK , \
